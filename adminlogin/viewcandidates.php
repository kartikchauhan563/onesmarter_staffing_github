...
include "connection.php";
    ...
    if (!isset($_SESSION['email'])) {
     ...
     if (isset($_GET['position'])) {
         $jobduties=$_GET['position'];
        
    //     $qry = mysqli_query($conn,"select * from addjobs where jobduties='$jobduties'");
    //     $row = mysqli_fetch_array($qry);
     }
$result = mysqli_query($conn,"SELECT * FROM candidates WHERE position='$jobduties'");
