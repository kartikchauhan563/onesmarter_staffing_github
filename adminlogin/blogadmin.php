<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if( in_array($imageFileType,$extensions_arr) ){
          ...
          $query="INSERT INTO `blogadmin`(`title`, `description`, `image`) VALUES ('$title', '$description','$image')";
      ...
      <div class="container-fluid">
                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <form action="blogadmin.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            $result = mysqli_query($conn,"SELECT * FROM blogadmin");
